...
namespace IsekaiMod.Content.Deities
{
	internal class Besmara
	{
		...
		private static readonly BlueprintFeature WarDomainAllowed = BlueprintTools.GetBlueprint<BlueprintFeature>("3795653d6d3b291418164b27be88cb43");
		...
		private static readonly BlueprintFeature RapierProficiency = BlueprintTools.GetBlueprint<BlueprintFeature>("292d51f3d6a331644a8c29be0614f671");

		private static readonly BlueprintItem RapierPlus1 = BlueprintTools.GetBlueprint<BlueprintItem>("390c6a76f872f0e499d0d1310d430279");

		public static void Add()
		{
			Sprite Icon_Besmara = AssetLoader.LoadInternal(Main.IsekaiContext, "Deities", "ICON_BESMARA.png");
			IsekaiDeitySelection.AddToSelection(Helpers.CreateBlueprint(Main.IsekaiContext, "BesmaraFeature", delegate(BlueprintFeature bp)
			{
				bp.SetName(Main.IsekaiContext, "Besmara");
				bp.SetDescription(Main.IsekaiContext, "Besmara, known as the Pirate Queen, is the fierce goddess of piracy, sea monsters, strife, and audacious maritime chaos.\nSailing across the planar currents of the Astral Plane and the Great Beyond, she cares nothing for stuffy mortal laws, chivalric oaths, or orderly crusades. She loves the thrill of danger, daring wagers, and violent plunder. In the Constellation Chat, Besmara cheers wildly whenever you take reckless gambles or slice down formidable demons with flashy precision.\nDomains: Chaos, War, Trickery, Water\nFavoured Weapon: Rapier");
				((BlueprintUnitFact)bp).m_Icon = Icon_Besmara;
				...
				{
					c.m_BasicItems = new BlueprintItemReference[1] { RapierPlus1.ToReference<BlueprintItemReference>() };
