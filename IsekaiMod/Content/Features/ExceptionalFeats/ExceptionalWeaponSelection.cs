...
namespace IsekaiMod.Content.Features.ExceptionalFeats
{
	...
	{
		private static readonly Sprite Icon_ArcaneWeapon = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintFeature>("3cbe3e308342b3247ba2f4fbaf5e6307"))?.m_Icon;

		private static readonly Sprite Icon_ArcaneWeaponUnholyBuff = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintBuff>("9140db37a973e6543b5906d6da5780f7"))?.m_Icon;

		private static readonly Sprite Icon_ArcaneWeaponFrostBuff = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintBuff>("39f8c2ca61fa4bb419b13813001125ce"))?.m_Icon;

		private static readonly Sprite Icon_ArcaneWeaponShockBuff = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintBuff>("5b76e44a1ed84704e858c38e7e97e7f2"))?.m_Icon;

		private static readonly Sprite Icon_ArcaneWeaponFlamingBuff = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintBuff>("32e17840df49fbd48b835d080f5673a4"))?.m_Icon;

		private static readonly Sprite Icon_ArcaneWeaponKeenBuff = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintBuff>("49083bf0cdd00ec4dacbffb4be26e69a"))?.m_Icon;
		...
		{
			BlueprintFeatureReference[] ExceptionalWeaponFeatures = new BlueprintFeatureReference[5]
			{
			...
			LocalizedString ExceptionalWeaponSelectionDesc = Helpers.CreateString(Main.IsekaiContext, "ExceptionalWeaponSelection.Description", "Your primary and secondary weapons have an additional enchantment.");
			BlueprintFeatureSelection selection = Helpers.CreateBlueprint(Main.IsekaiContext, "ExceptionalWeaponSelection", delegate(BlueprintFeatureSelection bp)
			{
			...
			BlueprintFeatureSelection bonusSelection = Helpers.CreateBlueprint(Main.IsekaiContext, "ExceptionalWeaponBonusSelection", delegate(BlueprintFeatureSelection bp)
			{
				bp.SetName(Main.IsekaiContext, "Exceptional Weapon");
				bp.SetDescription(ExceptionalWeaponSelectionDesc);
				((BlueprintUnitFact)bp).m_Icon = Icon_ArcaneWeapon;
		...
		{
			return TTCoreExtensions.CreateToggleBuffFeature(name, description, icon, delegate(BlueprintBuff bp)
			{
