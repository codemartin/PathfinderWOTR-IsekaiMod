...
{
	public class ShadowMonarchLegacySelection
	{
		private static readonly LocalizedString Name = Helpers.CreateString(Main.IsekaiContext, "ShadowMonarchLegacySelection.Name", "Shadow Monarch Legacy");

		private static readonly LocalizedString Description = Helpers.CreateString(Main.IsekaiContext, "ShadowMonarchLegacySelection.Description", "You recall memories of awakening as the Monarch of Shadows, raising an eternal legion from the dead.");
		...
		public static void Configure()
		{
			...
			{
				ClassFeature = Helpers.CreateBlueprint(Main.IsekaiContext, "ShadowMonarchLegacySelection", delegate(BlueprintFeatureSelection bp)
				{
					bp.SetName(Name);
