...
namespace IsekaiMod.Content.Features
{
	internal class ExoticWeaponProficiency
	{
		...
		private static readonly Sprite Icon_ExcoticWeaponProficiency = ((BlueprintUnitFact)BlueprintTools.GetBlueprint<BlueprintFeatureSelection>("9a01b6815d6c3684cb25f30b8bf20932")).m_Icon;

		public static void Add()
		{
			WeaponCategory[] exoticWeaponCategories = new WeaponCategory[16]
			{
			...
			Helpers.CreateBlueprint(Main.IsekaiContext, "ExoticWeaponProficiency", delegate(BlueprintFeature bp)
			{
				bp.SetName(Main.IsekaiContext, "Exotic Weapon Proficiency");
				bp.SetDescription(Main.IsekaiContext, "You become proficient with all Exotic Weapons.");
				((BlueprintUnitFact)bp).m_Icon = Icon_ExcoticWeaponProficiency;
				bp.AddComponent(delegate(AddProficiencies c)
				{
					c.WeaponProficiencies = exoticWeaponCategories;
				});
				bp.AddComponent(delegate(PrerequisiteNotProficient c)
				{
