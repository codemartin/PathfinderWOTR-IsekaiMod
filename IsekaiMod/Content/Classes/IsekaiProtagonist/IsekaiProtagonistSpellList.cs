...
namespace IsekaiMod.Content.Classes.IsekaiProtagonist
{
	internal class IsekaiProtagonistSpellList
	{
		...
		private static readonly HashSet<BlueprintGuid> ExcludedSpellGuids = new HashSet<BlueprintGuid>
		{
			BlueprintGuid.Parse("0ec75ec95d9e39d47a23610123ba1bad"),
			BlueprintGuid.Parse("b6da529f710491b4fa789a5838c1ae8f"),
			BlueprintGuid.Parse("3026de673d4d8fe45baf40e0b5edd718"),
			BlueprintGuid.Parse("93f391b0c5a99e04e83bbfbe3bb6db64"),
			BlueprintGuid.Parse("224f03e74d1dd4648a81242c01e65f41"),
			BlueprintGuid.Parse("5bfd4cce1557d5744914f8f6d85959a4"),
			BlueprintGuid.Parse("8b8ccc9763e3cc74bbf5acc9c98557b9"),
			BlueprintGuid.Parse("1eaf1020e82028d4db55e6e464269e00"),
			BlueprintGuid.Parse("b70104f09b3da794da923fbf248befc5"),
			BlueprintGuid.Parse("c28f7234f5fb8c943a77621ad96ad8f9"),
			BlueprintGuid.Parse("eee384c813b6d74498d1b9cc720d61f4"),
			BlueprintGuid.Parse("07dccc8e4c4489c4d9de721dddaf12cc"),
			BlueprintGuid.Parse("2ac7637daeb2aa143a3bae860095b63e"),
			BlueprintGuid.Parse("c3aafbbb6e8fc754fb8c82ede3280051"),
			BlueprintGuid.Parse("07e8f6479cbcc3f46a12696784805305"),
			BlueprintGuid.Parse("a6c41f10be92dec488276ab079a296c8"),
			BlueprintGuid.Parse("1c509c6f186528b49a291ab77f7f997d"),
			BlueprintGuid.Parse("a0df3fc5fda5c7b4bbec8443e5bb315a"),
			BlueprintGuid.Parse("e4926aa766a1cc048835237b3a97597d"),
			BlueprintGuid.Parse("a4849d6bd536ade48a3839a4ad960a8b"),
			BlueprintGuid.Parse("ee63301f83c76694692d4704d8a05bdc"),
			BlueprintGuid.Parse("facdc8851a0b3f44a8bed50f0199b83c"),
			BlueprintGuid.Parse("c281eeecc554b72449fef43924e522ce"),
			BlueprintGuid.Parse("96d2ab91f2d2329459a8dab496c5bede"),
			BlueprintGuid.Parse("b140c323981ba0a45a3bee5a1a57f493"),
			BlueprintGuid.Parse("cd4b858611f11ec44861f02505f9261d"),
			BlueprintGuid.Parse("4814f8645d1d77447a70479c0be51c72"),
			BlueprintGuid.Parse("5bdc37e4acfa209408334326076a43bc"),
			BlueprintGuid.Parse("78e0d5e8ad0e3eb4c8d65e0d34b945b4"),
			BlueprintGuid.Parse("431f783e1a020cd46ab37b8666a92bd3"),
			BlueprintGuid.Parse("41c9016596fe1de4faf67425ed691203")
		};

		public static void Add()
		{
			Helpers.CreateBlueprint(Main.IsekaiContext, "IsekaiProtagonistSpellList", delegate(BlueprintSpellList bp)
			{
		...
		{
			return BlueprintTools.GetModBlueprint<BlueprintSpellList>(Main.IsekaiContext, "IsekaiProtagonistSpellList");
		}

		public static BlueprintSpellListReference GetReference()
		{
			return BlueprintTools.GetModBlueprintReference<BlueprintSpellListReference>(Main.IsekaiContext, "IsekaiProtagonistSpellList");
		}
		...
		public static void MergeSpellLists()
		{
			...
			if (SpellTools.SpellList.ClericSpellList?.SpellsByLevel != null)
			{
				SpellLevelList[] spellsByLevel = SpellTools.SpellList.ClericSpellList.SpellsByLevel;
				foreach (SpellLevelList spellLevelList in spellsByLevel)
				{
					...
					{
						if (spell != null && !ExcludeSpell(spell))
						{
							TTCoreExtensions.RegisterSpell(blueprintSpellList, spell, spellLevelList.SpellLevel);
						}
					}
				}
			}
			if (SpellTools.SpellList.WizardSpellList?.SpellsByLevel != null)
			{
				SpellLevelList[] spellsByLevel = SpellTools.SpellList.WizardSpellList.SpellsByLevel;
				foreach (SpellLevelList spellLevelList2 in spellsByLevel)
				{
					if (spellLevelList2?.Spells == null)
					{
						continue;
					}
					foreach (BlueprintAbility spell2 in spellLevelList2.Spells)
					{
						if (spell2 != null && !ExcludeSpell(spell2))
						{
							TTCoreExtensions.RegisterSpell(blueprintSpellList, spell2, spellLevelList2.SpellLevel);
						}
					}
				}
			}
			if (SpellTools.SpellList.DruidSpellList?.SpellsByLevel != null)
			{
				SpellLevelList[] spellsByLevel = SpellTools.SpellList.DruidSpellList.SpellsByLevel;
				foreach (SpellLevelList spellLevelList3 in spellsByLevel)
				{
					if (spellLevelList3?.Spells == null)
					{
						continue;
					}
					foreach (BlueprintAbility spell3 in spellLevelList3.Spells)
					{
						if (spell3 != null && !ExcludeSpell(spell3))
						{
							TTCoreExtensions.RegisterSpell(blueprintSpellList, spell3, spellLevelList3.SpellLevel);
						}
					}
				}
			}
			BlueprintSpellList[] array = new BlueprintSpellList[70]
			{
				...
				SpellTools.SpellList.CharmDomainSpellList,
				SpellTools.SpellList.CommunityDomainSpellList,
				SpellTools.SpellList.DarknessDomainSpellList,
				SpellTools.SpellList.DeathDomainSpellList,
				SpellTools.SpellList.DestructionDomainSpellList,
				SpellTools.SpellList.EarthDomainSpellList,
				SpellTools.SpellList.EvilDomainSpellList,
				SpellTools.SpellList.FeyspeakerSpelllist,
				SpellTools.SpellList.FireDomainSpellList,
				SpellTools.SpellList.FlamesSpiritSpellList,
				SpellTools.SpellList.FrostSpiritSpellList,
				SpellTools.SpellList.GloryDomainSpellList,
				SpellTools.SpellList.GoodDomainSpellList,
				SpellTools.SpellList.HealingDomainSpellList,
				SpellTools.SpellList.KnowledgeDomainSpellList,
				SpellTools.SpellList.LawDomainSpellList,
				SpellTools.SpellList.LiberationDomainSpellList,
				SpellTools.SpellList.LifeSpiritSpellList,
				SpellTools.SpellList.LuckDomainSpellList,
				SpellTools.SpellList.MadnessDomainSpellList,
				SpellTools.SpellList.MagicDomainSpellList,
				SpellTools.SpellList.NatureSpiritSpellList,
				SpellTools.SpellList.NobilityDomainSpellList,
				SpellTools.SpellList.PlantDomainSpellList,
				SpellTools.SpellList.ProtectionDomainSpellList,
				SpellTools.SpellList.RangerSpellList,
				SpellTools.SpellList.ReposeDomainSpellList,
				SpellTools.SpellList.RuneDomainSpellList,
				SpellTools.SpellList.ShamanSpelllist,
				SpellTools.SpellList.SpiritWardenSpellList,
				SpellTools.SpellList.StoneSpiritSpellList,
				SpellTools.SpellList.StrengthDomainSpellList,
				SpellTools.SpellList.SunDomainSpellList,
				SpellTools.SpellList.ThassilonianAbjurationSpellList,
				SpellTools.SpellList.ThassilonianConjurationSpellList,
				SpellTools.SpellList.ThassilonianEnchantmentSpellList,
				SpellTools.SpellList.ThassilonianEvocationSpellList,
				SpellTools.SpellList.ThassilonianIllusionSpellList,
				SpellTools.SpellList.ThassilonianNecromancySpellList,
				SpellTools.SpellList.ThassilonianTransmutationSpellList,
				SpellTools.SpellList.TravelDomainSpellList,
				SpellTools.SpellList.TrickeryDomainSpellList,
				SpellTools.SpellList.WarDomainSpellList,
				SpellTools.SpellList.WarpriestSpelllist,
				SpellTools.SpellList.WaterDomainSpellList,
				SpellTools.SpellList.WavesSpiritSpellList,
				SpellTools.SpellList.WeatherDomainSpellList,
				SpellTools.SpellList.WindSpiritSpellList,
				SpellTools.SpellList.WitchSpellList,
				SpellTools.SpellList.WizardAbjurationSpellList,
				SpellTools.SpellList.WizardConjurationSpellList,
				SpellTools.SpellList.WizardDivinationSpellList,
				SpellTools.SpellList.WizardEnchantmentSpellList,
				SpellTools.SpellList.WizardEvocationSpellList,
				SpellTools.SpellList.WizardIllusionSpellList,
				SpellTools.SpellList.WizardNecromancySpellList,
				SpellTools.SpellList.WizardTransmutationSpellList,
			...
			foreach (BlueprintSpellList blueprintSpellList2 in array)
			{
				if (blueprintSpellList2?.SpellsByLevel == null)
				{
					continue;
				}
				SpellLevelList[] spellsByLevel = blueprintSpellList2.SpellsByLevel;
				foreach (SpellLevelList spellLevelList4 in spellsByLevel)
				{
					if (spellLevelList4?.Spells == null)
					{
						continue;
					}
					foreach (BlueprintAbility spell4 in spellLevelList4.Spells)
					{
						if (spell4 != null && !ExcludeSpell(spell4))
						{
							TTCoreExtensions.RegisterSpell(blueprintSpellList, spell4, spellLevelList4.SpellLevel);
						}
					}
				}
			}
			List<BlueprintAbility> cantrips = blueprintSpellList.GetSpells(0);
			BlueprintFeature modBlueprint = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "IsekaiCantrips");
			if (modBlueprint == null || cantrips == null)
			{
				return;
			}
			modBlueprint.AddComponent(delegate(AddFacts c)
			{
				...
				foreach (BlueprintAbility item in cantrips)
				{
					if (item != null)
					{
						c.m_Facts = c.m_Facts.AppendToArray(item.ToReference<BlueprintUnitFactReference>());
					}
				}
			});
		}
