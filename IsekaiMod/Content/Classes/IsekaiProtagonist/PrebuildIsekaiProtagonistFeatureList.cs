...
namespace IsekaiMod.Content.Classes.IsekaiProtagonist
{
	internal class PrebuildIsekaiProtagonistFeatureList
	{
		...
		{
			BlueprintFeature PowerAttack = BlueprintTools.GetBlueprint<BlueprintFeature>("9972f33f977fc724c838e59641b2fca5");
			BlueprintFeature CombatReflexes = BlueprintTools.GetBlueprint<BlueprintFeature>("0f8939ae6f220984e8fb568abbdfba95");
			BlueprintFeature ImprovedInitiative = BlueprintTools.GetBlueprint<BlueprintFeature>("797f25d709f559546b29e7bcb181cc74");
			BlueprintFeature IronWill = BlueprintTools.GetBlueprint<BlueprintFeature>("175d1577bb6c9a04baf88eec99c66334");
			BlueprintFeature Outflank = BlueprintTools.GetBlueprint<BlueprintFeature>("422dab7309e1ad343935f33a4d6e9f11");
			BlueprintFeature IronWillImproved = BlueprintTools.GetBlueprint<BlueprintFeature>("3ea2215150a1c8a4a9bfed9d9023903e");
			BlueprintFeature Dodge = BlueprintTools.GetBlueprint<BlueprintFeature>("97e216dbb46ae3c4faef90cf6bbe6fd5");
			BlueprintFeature Toughness = BlueprintTools.GetBlueprint<BlueprintFeature>("d09b20029e9abfe4480b356c92095623");
			BlueprintFeature SpellPenetration = BlueprintTools.GetBlueprint<BlueprintFeature>("ee7dc126939e4d9438357fbd5980d459");
			BlueprintFeature GreaterSpellPenetration = BlueprintTools.GetBlueprint<BlueprintFeature>("1978c3f91cfbbc24b9c9b0d017f4beec");
			BlueprintFeature Cleave = BlueprintTools.GetBlueprint<BlueprintFeature>("d809b6c4ff2aaff4fa70d712a70f7d7b");
			BlueprintFeature CleavingFinish = BlueprintTools.GetBlueprint<BlueprintFeature>("59bd93899149fa44687ff4121389b3a9");
			BlueprintFeature PointBlankShot = BlueprintTools.GetBlueprint<BlueprintFeature>("0da0c194d6e1d43419eb8d990b28e0ab");
			BlueprintFeature PreciseShot = BlueprintTools.GetBlueprint<BlueprintFeature>("8f3d1e6b4be006f4d896081f2f889665");
			BlueprintFeature DeadlyAim = BlueprintTools.GetBlueprint<BlueprintFeature>("f47df34d53f8c904f9981a3ee8e84892");
			BlueprintFeature GreatFortitude = BlueprintTools.GetBlueprint<BlueprintFeature>("79042cb55f030614ea29956177977c52");
			BlueprintFeature GreatFortitudeImproved = BlueprintTools.GetBlueprint<BlueprintFeature>("f5db1cc7ad48d794f85252fa4a64157b");
			BlueprintFeature LightningReflexes = BlueprintTools.GetBlueprint<BlueprintFeature>("15e7da6645a7f3d41bdad7c8c4b9de1e");
			BlueprintFeature LightningReflexesImproved = BlueprintTools.GetBlueprint<BlueprintFeature>("1e813eb8159b67a459b1c975027866e5");
			BlueprintFeature MaximizeSpellFeat = BlueprintTools.GetBlueprint<BlueprintFeature>("7f2b282626862e345935bbea5e66424b");
			BlueprintFeature EmpowerSpellFeat = BlueprintTools.GetBlueprint<BlueprintFeature>("a1de1e4f92195b442adb946f0e2b9d4e");
			BlueprintFeature BackgroundNone = BlueprintTools.GetBlueprint<BlueprintFeature>("7d300f497584d9245ac24c062dce0bd6");
			BlueprintFeatureSelection BackgroundBaseSelection = BlueprintTools.GetBlueprint<BlueprintFeatureSelection>("f926dabeee7f8a54db8f2010b323383c");
			BlueprintFeature PitbornHeritage = BlueprintTools.GetBlueprint<BlueprintFeature>("c09ffb2657f6c2b41b5ed0ed607b362a");
			BlueprintFeatureSelection TieflingHeritageSelection = BlueprintTools.GetBlueprint<BlueprintFeatureSelection>("c862fd0e4046d2d4d9702dd60474a181");
			BlueprintFeature AngelHeritage = BlueprintTools.GetBlueprint<BlueprintFeature>("ceedc840b113c3348a2f32b434df5fef");
			BlueprintFeatureSelection AasimarHeritageSelection = BlueprintTools.GetBlueprint<BlueprintFeatureSelection>("67aabcbce8f8ae643a9d08a6ca67cabd");
			BlueprintFeature SkillFocusPhysique = BlueprintTools.GetBlueprint<BlueprintFeature>("9db907332bdaec1468cff3a99efef5b4");
			BlueprintFeatureSelection Adaptibility = BlueprintTools.GetBlueprint<BlueprintFeatureSelection>("26a668c5a8c22354bac67bcd42e09a3f");
			...
			BlueprintTools.GetModBlueprint<BlueprintFeatureSelection>(Main.IsekaiContext, "IsekaiFamiliarSelection");
			BlueprintFeature CatFamiliarBondFeature = BlueprintTools.GetBlueprint<BlueprintFeature>("1cb0b559ca2e31e4d9dc65de012fa82f");
			...
			BlueprintFeatureSelection IsekaiPetSelection = BlueprintTools.GetModBlueprint<BlueprintFeatureSelection>(Main.IsekaiContext, "IsekaiPetSelection");
			...
			BlueprintFeatureSelection OverpoweredAbilitySelection = BlueprintTools.GetModBlueprint<BlueprintFeatureSelection>(Main.IsekaiContext, "OverpoweredAbilitySelection");
			...
			BlueprintFeature StartingWeaponLongsword = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "StartingWeaponLongsword");
			BlueprintFeature SignatureAttack = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "SignatureAttack");
			BlueprintFeature AutoQuickenFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AutoQuickenFeature");
			BlueprintFeature AutoMaximizeFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AutoMaximizeFeature");
			BlueprintFeature AutoSelectiveFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AutoSelectiveFeature");
			BlueprintFeature AutoEmpowerFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AutoEmpowerFeature");
			BlueprintFeature AutoExtendFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AutoExtendFeature");
			BlueprintFeature MasterSelf = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "MasterSelf");
			BlueprintFeature AlphaStrike = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "AlphaStrike");
			BlueprintFeature BetaStrike = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "BetaStrike");
			BlueprintFeature GammaStrike = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "GammaStrike");
			BlueprintFeature OmegaStrike = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "OmegaStrike");
			BlueprintFeature SneakyMagic = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "SneakyMagic");
			BlueprintFeature MundaneAura = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "MundaneAura");
			BlueprintFeature TrainingMontage = BlueprintTools.GetModBlueprint<BlueprintFeature>(Main.IsekaiContext, "TrainingMontage");
			IsekaiProtagonistClass.SetDefaultBuild(Helpers.CreateBlueprint(Main.IsekaiContext, "PrebuildIsekaiProtagonistFeatureList", delegate(BlueprintFeature bp)
			{
				bp.Ranks = 1;
				bp.HideInUI = true;
				bp.AddComponent(delegate(AddClassLevels c)
				{
					...
					c.Selections = new SelectionEntry[12]
					{
						new SelectionEntry
						{
							m_Selection = BasicFeatSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[10]
							{
						...
						new SelectionEntry
						{
							...
							m_Features = new BlueprintFeatureReference[11]
							{
						...
						new SelectionEntry
						{
							...
							m_Features = new BlueprintFeatureReference[5]
							{
						...
						new SelectionEntry
						{
							...
							m_Features = new BlueprintFeatureReference[7]
							{
						...
						new SelectionEntry
						{
							...
							m_Features = new BlueprintFeatureReference[1] { MasterSelf.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = Adaptibility.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { SkillFocusPhysique.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = AasimarHeritageSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { AngelHeritage.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = TieflingHeritageSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { PitbornHeritage.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = BackgroundBaseSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { BackgroundNone.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = StartingWeaponSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { StartingWeaponLongsword.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = IsekaiPetSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { CatFamiliarBondFeature.ToReference<BlueprintFeatureReference>() }
						},
						new SelectionEntry
						{
							m_Selection = SignatureMoveSelection.ToReference<BlueprintFeatureSelectionReference>(),
							m_Features = new BlueprintFeatureReference[1] { SignatureAttack.ToReference<BlueprintFeatureReference>() }
						}
					};
					c.m_SelectSpells = new BlueprintAbilityReference[224]
					{
				...
				bp.AddComponent(delegate(StatsDistributionPreset c)
				{
					c.TargetPoints = 20;
					c.Strength = 14;
					c.Dexterity = 12;
				...
				bp.AddComponent(delegate(BuildBalanceRadarChart c)
				{
					c.Control = 5;
					c.Defense = 5;
					c.Magic = 5;
