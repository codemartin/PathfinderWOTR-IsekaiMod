...
namespace IsekaiMod.Content.Dialogue
{
	internal class IsekaiRomanceDialogue
	{
		...
		private static void AddArueshalaeRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceArueshalae", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Arushalae... have you ever felt like you're an intruder in a world you weren't born into? Sometimes I look at the stars and dread that one morning I'll wake up back where I came from, and all of this, including us, will just vanish.\"");
		...
		private static void AddDaeranRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceDaeran", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Daeran, be honest with me. Do you ever get the feeling that none of this is real? That we're just actors playing out roles in some grand, absurd cosmic comedy?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddWenduagRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceWenduag", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Wenduag... you worship strength because the underground showed you no mercy. But what if I told you my power isn't mine? What if I'm just an ordinary person from another realm, chosen by arbitrary cosmic spectators who watch our struggle like theater?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddLannRomanceDialogue()
		{
			...
			BlueprintCue reply = TTCoreExtensions.CreateCue("IsekaiRomanceLannReply", delegate(BlueprintCue bp)
			{
				bp.SetText(Main.IsekaiContext, "{n}Lann chuckles softly, poking the campfire with an unstrung arrow before tossing it aside. He looks up at you, his half-human, half-lizard expression softening into quiet sincerity.{/n} \"Hey... look at me. Thirty years, forty years, an immortal spark from another dimension, who's counting? Down in the caves, our lives were measured in days between demonic incursions. If I've learned anything since stepping onto the surface, it's that time is a joke. It's what you do with the time that matters.\"\n\n{n}He reaches over and firmly clasps your shoulder.{/n} \"If you get ripped back to your world of concrete and glass towers tomorrow, then today was still the greatest adventure of my short mongrel life. And hey, if whatever cosmic force thinks it can take you away without a fight, it clearly hasn't met an archer with twenty-four arrows in flight before it can even blink. You're stuck with me, Chief. Planar barriers be damned.\"");
				if (lannUnit != null)
				{
					bp.Speaker = new DialogSpeaker
					{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceLann", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Lann, you always joke about your mongrel lifespan... but I have the opposite nightmare. I came from a world across time and space. What if my otherworldly existence means I can't stay here, or what if I'm torn back before we can build a life together?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddSosielRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceSosiel", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Sosiel... when you paint, you capture the soul of Golarion. But when I look at the sky, I feel like a ghost wandering someone else's tapestry. Do you ever fear that loving an otherworldly stranger is loving a shadow?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddGalfreyRomanceDialogue()
		{
			...
			if (incognitoAnswers != null)
			{
				BlueprintCue campReply = TTCoreExtensions.CreateCue("IsekaiRomanceGalfreyCampReply", delegate(BlueprintCue bp)
				{
					...
					bp.SetAnswersList(incognitoAnswers);
				});
				BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceGalfreyCamp", delegate(BlueprintAnswer bp)
				{
					bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Your Majesty... a century on the throne, bearing the expectations of an entire continent. I must confess, I did not choose this mythic mantle either. I was ripped from my home and thrust into this crusade. Do you ever wish you could cast the crown aside and just be yourself?\"");
					bp.NextCue = new CueSelection
					{
						Cues = new List<BlueprintCueBaseReference> { campReply.ToReference<BlueprintCueBaseReference>() },
						Strategy = Strategy.First
					};
					bp.ShowOnce = true;
					bp.RequirePlotArmor();
				});
				incognitoAnswers.InsertAnswer(answer);
			}
			if (drezenAnswers == null)
			{
				return;
			}
			BlueprintCue drezenReply = TTCoreExtensions.CreateCue("IsekaiRomanceGalfreyReply", delegate(BlueprintCue bp)
			{
				bp.SetText(Main.IsekaiContext, "{n}Galfrey's breath hitches. For a brief moment, the solemn, unyielding Queen of Mendev vanishes, replaced by an exhausted woman whose heart has carried a century of funeral pyres.{/n} \"More times than I can bear to confess to Iomedae, Commander.\"\n\n{n}She looks at you with a mixture of sorrow and profound kinship.{/n} \"Everyone sees the radiance of the Sunburst, the sunlit armor, the divine savior. No one sees the prison it creates. To know that you, too, were chosen by powers beyond your control... it is both heartbreaking and a strange, quiet comfort. In this camp of thousands, you are the only one who understands what it means to be an instrument of fate.\"\n\n{n}She steps closer, her armored hand resting gently over yours on the war table.{/n} \"When this war is won, Commander... whether your home lies across the ocean or across the stars... let us promise to lay down our armor together, if only for an hour. Just two weary souls who answered the call.\"");
				if (galfreyUnit != null)
				{
				...
				bp.SetAnswersList(drezenAnswers);
			});
			BlueprintAnswer answer2 = TTCoreExtensions.CreateAnswer("IsekaiRomanceGalfrey", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Your Majesty... a century on the throne, bearing the expectations of an entire continent. I must confess, I did not choose this mythic mantle either. I was ripped from my home and thrust into this crusade. Do you ever wish you could cast the crown aside and just be yourself?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { drezenReply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
				};
				bp.ShowOnce = true;
				bp.RequirePlotArmor();
			});
			drezenAnswers.InsertAnswer(answer2);
		}
		...
		private static void AddCamelliaRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceCamellia", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Camellia... you claim you're not normal because of the spirits and your desires. But what if I told you I'm not even from this dimension? Back home, we didn't have shamanic spirits or gods, just cold technology. Does loving someone from outside reality frighten you?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddUlbrigRomanceDialogue()
		{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceUlbrig", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Ulbrig... you survived a century frozen in stone, watching everything you loved turn to ash. I came from another world across the multiverse, knowing I can never truly go back. Do you ever feel like we're both ghosts haunting a world that moved on without us?\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
		...
		private static void AddUlbrigDanceOfMasksRomanceDialogue()
		{
			...
			BlueprintCue reply = TTCoreExtensions.CreateCue("IsekaiRomanceUlbrigDanceOfMasksReply", delegate(BlueprintCue bp)
			{
				bp.SetText(Main.IsekaiContext, "{n}Ulbrig chuckles softly, offering you a cup of spiced cider with a grin that wrinkles the corners of his eyes.{/n} \"No electric lights here, my clever traveler. Just good cider, warm music, and a griffon who finally found his favorite perch.\"\n\n{n}He pulls you close against his chest, wrapping his feathered arm around your shoulders against the evening chill.{/n} \"The old world is gone, and your world across the void is far away. But tonight, this city belongs to us. No demons, no dead gods... just you and me dancing beneath the masks.\"");
				if (ulbrigUnit != null)
				{
					bp.Speaker = new DialogSpeaker
					{
			...
			BlueprintAnswer answer = TTCoreExtensions.CreateAnswer("IsekaiRomanceUlbrigDanceOfMasks", delegate(BlueprintAnswer bp)
			{
				bp.SetText(Main.IsekaiContext, "(Isekai Protagonist) \"Ulbrig, look at this festival. Rebuilt cobblestones, masked revelers, sweet wine... In my old world, people celebrated under electric fireworks, pretending tomorrow didn't matter either. But tonight, with you, this world actually feels like home.\"");
				bp.NextCue = new CueSelection
				{
					Cues = new List<BlueprintCueBaseReference> { reply.ToReference<BlueprintCueBaseReference>() },
					Strategy = Strategy.First
