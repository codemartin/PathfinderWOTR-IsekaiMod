...
namespace IsekaiMod.Content.Dialogue
{
	internal static class IsekaiCampaignExpansions
	{
		...
		public const string MythicClassDemon = "8e3d94b1c30423d4e95063e3528f8303";

		public const string MythicClassAeon = "15a85e67b7d69554cab9ed5830d0268e";

		public const string MythicClassAzata = "9a3b2c63afa259e49a426da561ac3679";

		public const string MythicClassLich = "5d50712e707ffab4bb3111d40dcdb666";

		public const string MythicClassTrickster = "8df873884aa1c6f49b01b451ec9ab11f";

		public const string MythicClassLegend = "ba34257984f4c41408ce1dc2097e31a5";

		public const string MythicClassGoldDragon = "365a5293297a7e4489a23cac18e00868";

		public const string MythicClassSwarm = "5295b8e13c2303c468b5a1dd760e69b2";

		public const string MythicClassDevil = "7e452a4206822a54fb0a424e867d3d2a";
		...
		private static void InjectAct3Encounters()
		{
			...
			if (blueprint2 != null)
			{
				...
				AddMythicAnswer(blueprint2, "IsekaiHeraldAzataJoyousAffirmation", "(Hero) [Azata] [Song of the Free Hearts] \"We don't need rigid dogmas to save this world, Herald. As long as freedom, kindness, and fellowship guide us, the demons don't stand a chance!\"", "{n}The Herald chuckles softly, his stern celestial demeanor softening.{/n} \"Your innocence and boundless courage bring warmth to this scarred earth, young hero.\"", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 6);
			}
			...
			if (blueprint8 != null)
			{
				...
				AddMythicAnswer(blueprint8, "IsekaiGreengatesHeroAzataSong", "(Hero) [Azata] [Chime of Elysium] \"Let the bells ring with the joy of tomorrow, Arueshalae! Even in the deepest shadows, the seeds of Elysium will always blossom!\"", "{n}Vibrant rainbow petals swirl around the belltower as celestial melodies dissolve every trace of demonic taint in the grove.{/n}", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 6);
			}
			...
			if (blueprint12 != null)
			{
				...
				AddMythicAnswer(blueprint12, "IsekaiFaneBreachHeroAzataDawnMarch", "(Hero) [Azata] [Marching toward the Dawn] \"For everyone waiting for us back home, we march into hell and bring back the dawn! Follow me, everyone!\"", "{n}A chorus of hopeful song swells among your companions and soldiers, banishing all shadow from their hearts!{/n}", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 6);
			}
		...
		private static void InjectAct4Encounters()
		{
			...
			if (blueprint3 != null)
			{
				...
				AddMythicAnswer(blueprint3, "IsekaiBattleblissHeroAzataFreedomSong", "(Hero) [Azata] [Song of the Unbroken] \"Hear me, fighters! You are not beasts to be slaughtered! Fight for your freedom, fight for tomorrow! We break these walls together!\"", "{n}Your stirring battle-hymn echoes across the coliseum, igniting a full-scale gladiator revolt as slaves shatter their holding gates!{/n}", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 6);
			}
			...
			if (blueprint9 != null)
			{
				...
				AddMythicAnswer(blueprint9, "IsekaiBaphometLegendMartialChallenger", "(Martial God) [Legend] [The God-Slayer's Roar] \"A Demon Lord in the flesh! Finally, a neck thick enough to test the full power of my blade! Come, beast, show me your labyrinth!\"", "{n}Your weapon roars with a hurricane of pressurized air, cutting deep gouges into the cavern walls before you even take a step forward!{/n}", "ba34257984f4c41408ce1dc2097e31a5", "MartialGodProficiencies", AlignmentShiftDirection.TrueNeutral, 7);
				...
				AddMythicAnswer(blueprint9, "IsekaiBaphometHeroAzataHeartOfFreedom", "(Hero) [Azata] [The Song That Breaks All Mazes] \"No labyrinth can trap a heart that flies free! For everyone you butchered in the crusade, we stand unbroken and we will never bow!\"", "{n}Celestial song cascades through the volcanic caverns, shattering Baphomet's despair curse across your entire retinue!{/n}", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 7);
			}
		...
		private static void InjectAct5Encounters()
		{
			...
			if (blueprint6 != null)
			{
				...
				AddMythicAnswer(blueprint6, "IsekaiDeskariHeroAzataDawnOfMankind", "(Hero) [Azata] [The Song of Kenabres Avenged] \"For everyone who lost someone in Kenabres! For every family torn apart! We stand together, and we bring back the dawn!\"", "{n}A glorious chorus of celestial harmonies rings across Iz, filling your companions with unstoppable courage as Deskari recoils in fear!{/n}", "9a3b2c63afa259e49a426da561ac3679", "HeroProficiencies", AlignmentShiftDirection.Good, 8);
			}
